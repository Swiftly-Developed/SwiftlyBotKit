...
func botKitConfiguration() -> BotKitConfiguration {
    ...
    // The switcher. Keys match what siteKey returns; logos are served by FileMiddleware.
    config.sites = [
        BotDashboardSite(key: "shop", name: "Shop", logoPath: "/images/logos/shop.svg"),
        BotDashboardSite(key: "docs", name: "Documentation", logoPath: "/images/logos/docs.svg"),
    ]
